...
public class NavActivity_Rotaonly extends FragmentActivity implements OnMapReadyCallback {
        ...
        */
        ...
        if (!origem.isEmpty() && !destino.isEmpty()) {
            ...
            try {
                ...
                DirectionsResult results = getDirectionsDetails(origem, destino,TravelMode.DRIVING);
                if (results != null) {
